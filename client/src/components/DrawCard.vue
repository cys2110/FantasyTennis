...
<template>
    <div class="draw-card-wrapper">
        <div class="card-component">
            ...
            <div class="component-column">
                <div class="component-row" v-if="match.player_1"><RouterLink :to="{name: 'PlayerOverview', params: {id: match.player_1._id}}" class="hover-link">{{ player1Name }}</RouterLink> <span v-if="match.player_1_seed || match.player_1_status" class="small"><small>{{ player1Status }}</small></span></div>
                <div class="component-row" v-else-if="match.bye">Bye</div>
                <div class="component-row" v-else>Player 1</div>
                <div class="component-row" v-if="match.player_2"><RouterLink :to="{name: 'PlayerOverview', params: {id: match.player_2._id}}" class="hover-link">{{ player2Name }}</RouterLink> <span v-if="match.player_2_seed || match.player_2_status" class="small"><small>{{ player2Status }}</small></span></div><div class="component-row" v-else-if="match.bye">Bye</div>
